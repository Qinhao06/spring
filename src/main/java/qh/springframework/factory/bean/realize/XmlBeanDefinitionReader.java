...
import qh.springframework.factory.bean.realize.abstractrelize.AbstractBeanDefinitionReader;
import qh.springframework.factory.io.Resource;
...
public class XmlBeanDefinitionReader extends AbstractBeanDefinitionReader {
    ...
    protected void doLoadBeanDefinitions(InputStream is) throws ClassNotFoundException, BeansException, DocumentException {
        ...
        getRegistry().registerBeanDefinition("ConversionServiceFactoryBean",
                new BeanDefinition(ConversionServiceFactoryBean.class));
