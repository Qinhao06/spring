...
import qh.springframework.factory.bean.realize.SimpleInstantiationStrategy;
            ...
            if(null != propertyValues){
                for(PropertyValue propertyValue : propertyValues.getPropertyValues()){
                    ...
                    if(propertyValueObject instanceof BeanReference){
                        ...
                        Class<?> sourceType = propertyValueObject.getClass();
                        Class<?> targetType = (Class<?>) TypeUtil.getFieldType(bean.getClass(), propertyName);
                        ConversionService conversionService = getConversionService();
                        if(conversionService != null){
                            if(conversionService.canConvert(sourceType, targetType)){
                                propertyValueObject = conversionService.convert(propertyValueObject, targetType);
                            }
                        }
